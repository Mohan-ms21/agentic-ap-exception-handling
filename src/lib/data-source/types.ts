...
export interface ExceptionDataSource {
  ...
  /**
   * Evaluation results: the named n8n model runs (baseline and hardened),
   * each possibly not imported yet, and the scoring self-test, which must
   * never be presented as a model result.
   */
